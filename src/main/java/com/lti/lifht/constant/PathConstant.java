...
public class PathConstant {
    ...
    public static final String PATH_LOGIN_ERROR = PATH_LOGIN + "?error";
    ...
    public static final String PATH_ASSET_ANY = "/assests/**";

    public static final String PARAM_PS_NUMBER = "psNumber";
